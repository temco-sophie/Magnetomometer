###########################################################################
## File : find_resultant_rtw.mk
## 
## Makefile generated for MATLAB file/project 'find_resultant'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\find_resultant.lib
...
PRODUCT_NAME              = find_resultant
MAKEFILE                  = find_resultant_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\FIND_R~1
...
TOOLCHAIN_MAKEFILE = find_resultant_rtw_tools.mk

!include find_resultant_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\find_resultant.lib
...
DEFINES_STANDARD = -DMODEL=find_resultant -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\find_resultant_initialize.c $(START_DIR)\find_resultant_terminate.c $(START_DIR)\find_resultant.c $(START_DIR)\power.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = find_resultant_initialize.obj find_resultant_terminate.obj find_resultant.obj power.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
