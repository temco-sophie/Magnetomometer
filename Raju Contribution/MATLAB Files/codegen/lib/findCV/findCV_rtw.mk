...
## File : findCV_rtw.mk
## 
## Makefile generated for MATLAB file/project 'findCV'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\findCV.lib
...
PRODUCT_NAME              = findCV
MAKEFILE                  = findCV_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\findCV
...
TOOLCHAIN_MAKEFILE = findCV_rtw_tools.mk

!include findCV_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\findCV.lib
...
DEFINES_STANDARD = -DMODEL=findCV -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\findCV_initialize.c $(START_DIR)\findCV_terminate.c $(START_DIR)\findCV.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = findCV_initialize.obj findCV_terminate.obj findCV.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
