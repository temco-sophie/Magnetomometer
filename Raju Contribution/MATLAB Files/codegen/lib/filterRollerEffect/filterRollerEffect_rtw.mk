###########################################################################
## File : filterRollerEffect_rtw.mk
## 
## Makefile generated for MATLAB file/project 'filterRollerEffect'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\filterRollerEffect.lib
...
PRODUCT_NAME              = filterRollerEffect
MAKEFILE                  = filterRollerEffect_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\FILTER~1
...
TOOLCHAIN_MAKEFILE = filterRollerEffect_rtw_tools.mk

!include filterRollerEffect_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\filterRollerEffect.lib
...
DEFINES_STANDARD = -DMODEL=filterRollerEffect -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\filterRollerEffect_data.c $(START_DIR)\filterRollerEffect_initialize.c $(START_DIR)\filterRollerEffect_terminate.c $(START_DIR)\filterRollerEffect.c $(START_DIR)\rand.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = filterRollerEffect_data.obj filterRollerEffect_initialize.obj filterRollerEffect_terminate.obj filterRollerEffect.obj rand.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
