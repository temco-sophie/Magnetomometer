...
## File : fft_fp_rtw.mk
## 
## Makefile generated for MATLAB file/project 'fft_fp'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\fft_fp.lib
...
PRODUCT_NAME              = fft_fp
MAKEFILE                  = fft_fp_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\CO2_SE~1\code\Raju\MATLAB\codegen\lib\fft_fp
...
TOOLCHAIN_MAKEFILE = fft_fp_rtw_tools.mk

!include fft_fp_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\fft_fp.lib
...
DEFINES_STANDARD = -DMODEL=fft_fp -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\fft_fp_initialize.c $(START_DIR)\fft_fp_terminate.c $(START_DIR)\fft_fp.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = fft_fp_initialize.obj fft_fp_terminate.obj fft_fp.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
