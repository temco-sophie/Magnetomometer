###########################################################################
## File : checkLargeNoiseMetal_rtw.mk
## 
## Makefile generated for MATLAB file/project 'checkLargeNoiseMetal'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\checkLargeNoiseMetal.lib
...
PRODUCT_NAME              = checkLargeNoiseMetal
MAKEFILE                  = checkLargeNoiseMetal_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\CHECKL~1
...
TOOLCHAIN_MAKEFILE = checkLargeNoiseMetal_rtw_tools.mk

!include checkLargeNoiseMetal_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\checkLargeNoiseMetal.lib
...
DEFINES_STANDARD = -DMODEL=checkLargeNoiseMetal -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\checkLargeNoiseMetal_initialize.c $(START_DIR)\checkLargeNoiseMetal_terminate.c $(START_DIR)\checkLargeNoiseMetal.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = checkLargeNoiseMetal_initialize.obj checkLargeNoiseMetal_terminate.obj checkLargeNoiseMetal.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
