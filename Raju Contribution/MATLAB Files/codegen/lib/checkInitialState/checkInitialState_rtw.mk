###########################################################################
## File : checkInitialState_rtw.mk
## 
## Makefile generated for MATLAB file/project 'checkInitialState'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\checkInitialState.lib
...
PRODUCT_NAME              = checkInitialState
MAKEFILE                  = checkInitialState_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\CHECKI~1
...
TOOLCHAIN_MAKEFILE = checkInitialState_rtw_tools.mk

!include checkInitialState_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\checkInitialState.lib
...
DEFINES_STANDARD = -DMODEL=checkInitialState -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\checkInitialState_initialize.c $(START_DIR)\checkInitialState_terminate.c $(START_DIR)\checkInitialState.c $(START_DIR)\findCV.c $(START_DIR)\mean.c $(START_DIR)\checkInitialState_emxutil.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = checkInitialState_initialize.obj checkInitialState_terminate.obj checkInitialState.obj findCV.obj mean.obj checkInitialState_emxutil.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
