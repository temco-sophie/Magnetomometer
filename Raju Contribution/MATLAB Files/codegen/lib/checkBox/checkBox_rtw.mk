###########################################################################
## File : checkBox_rtw.mk
## 
## Makefile generated for MATLAB file/project 'checkBox'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\checkBox.lib
...
PRODUCT_NAME              = checkBox
MAKEFILE                  = checkBox_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2013a
START_DIR                 = C:\Users\Raju\Desktop\Github\MAGNET~1\RAJUCO~1\MATLAB~1\codegen\lib\checkBox
...
TOOLCHAIN_MAKEFILE = checkBox_rtw_tools.mk

!include checkBox_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\checkBox.lib
...
DEFINES_STANDARD = -DMODEL=checkBox -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)\checkBox_initialize.c $(START_DIR)\checkBox_terminate.c $(START_DIR)\checkBox.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = checkBox_initialize.obj checkBox_terminate.obj checkBox.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
